...
public partial class NwContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        ...
        => optionsBuilder.UseSqlServer("Server=.;Database=dbnwind;uid=sa;password=Sanane79!;Trusted_Connection=True;Integrated Security=false;TrustServerCertificate=True");
